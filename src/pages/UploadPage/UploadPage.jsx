...
import { Container, Card, CardContent, TextField, Button, Typography } from '@material-ui/core';
        ...
        <Card className={classes.card}>
          <CardContent>
            ...
            <form className={classes.form} onSubmit={handleSubmit}>
              ...
              />
              <TextField label="Person" required value={person} onChange={(e) => setPerson(e.target.value)} />
              <TextField label="Description" required multiline minRows={4} value={description} onChange={(e) => setDescription(e.target.value)} />
